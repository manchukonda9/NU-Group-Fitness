...
<body class="container p-3 my-3 bg-dark text-white">
	...
	<table class="table table-striped table-dark table-hover">
				...
				<c:forEach var="tempClass" items="${classes}">
					...
					<c:url var="updateClassLink" value="/admin/updateclass">
						<c:param name="classId" value="${tempClass.id}" />
					</c:url>	
							<c:url var="deleteClassLink" value="/admin/delete">
						<c:param name="classId" value="${tempClass.id}" />
					</c:url>	
					...
					<tr>
						...
						<td>
							...
							<a href="${updateClassLink}">Update Class</a>
							
							<a href="${deleteClassLink}">Delete Class</a>
